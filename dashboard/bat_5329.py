...
# def time_vs_avg_price():
#     x=html.Div(
#     children=[
#         html.H1(
#             children="BATTERY-5308 Analytics",
#         ),])
#     x=dcc.Graph(
#             figure={
#                 "data": [
...
data_details = pd.read_excel("5329.xls",sheet_name="Detail_67_3_1")
data_temp=pd.read_excel("5329.xls",sheet_name="DetailTemp_67_3_1")
# data = data.query("type == 'conventional'")
# data["Date"] = pd.to_datetime(data["Date"], format="%Y-%m-%d")
# data.sort_values("Date", inplace=True)
